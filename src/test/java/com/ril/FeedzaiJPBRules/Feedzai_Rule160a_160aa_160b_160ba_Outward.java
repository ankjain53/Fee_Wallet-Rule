...
{
	@Test(priority=1, description="Pulse Changes-Rule 160a")
	public void PulseChange_160a() throws Exception 
	{
		...
		@Test(priority=2, description="Pulse Changes-Rule 160aa")
		...
		@Test(priority=3, description="Pulse Changes-Rule 160b")
		...
		@Test(priority=4, description="Pulse Changes-Rule 160ba")
		...
		@Test(priority=5, description="List Changes-Rule 160ba")
		...
		@Test(priority=6, description="Validate Rule 160a_160aa_160b_160ba trigger")
		public void AM_Verify_160a_160aa_160b_160ba() throws Exception 
		{
			...
			Thread.sleep(4000);
			driver.findElement(By.xpath(pro.getProperty("AM_EnterTransactionId"))).sendKeys("");
			Thread.sleep(4000);
		...
		@Test(priority=7, description="Pulse Revert changes-160a")
		public void PulseRevert_160a() throws Exception 
		{
			...
			Login_LogOut.SetRuleVariable("attempted_sender_beneficiary_pan_jpb_neft_day_count = (approved_sender_beneficiary_pan_jpb_neft_day[event.sender_pan,event.beneficiary_pan].count ?? 0) + attempted_count; limit = 50000;");
		...
		@Test(priority=8, description="Pulse Revert changes-160aa")
		public void PulseRevert_160aa() throws Exception 
		{
			...
			Login_LogOut.SetRuleVariable("attempted_sender_beneficiary_pan_jpb_neft_day_amount = (approved_sender_beneficiary_pan_jpb_neft_day[event.sender_pan,event.beneficiary_pan].amount ?? 0) + attempted_amount; limit = 50000;");
		...
		@Test(priority=9, description="List changes Revert-160ba")
		public void ListChangeRevert_160ba() throws Exception 
		{
			...
			driver.findElement(By.xpath(pro.getProperty("Outward_count_month"))).clear();
			Thread.sleep(6000);
			driver.findElement(By.xpath(pro.getProperty("Outward_count_month"))).sendKeys("50");
			Thread.sleep(6000);
			driver.findElement(By.xpath(pro.getProperty("Outward_amount_month"))).click();
			Thread.sleep(6000);
			driver.findElement(By.xpath(pro.getProperty("Outward_amount_month"))).clear();
			Thread.sleep(6000);
			driver.findElement(By.xpath(pro.getProperty("Outward_amount_month"))).sendKeys("50000");
			Thread.sleep(6000);
			//CHECK LIMIT IS ENABLED
			Login_LogOut.EnableLimitCheckbox();
			driver.findElement(By.xpath(pro.getProperty("pulse_SaveEntry"))).click();
